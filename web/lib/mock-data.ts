...
export const NPCS: NpcDef[] = [
  ...
  // ── 통문 주둔지 ──
  { id: 'npc-guard', name: '경비대장 로한', role: 'guard', icon: '/images/npc/guard.svg', zoneId: 'z-barracks', cell: { x: 19, y: 17.2 }, greeting: ['야생으로 나가려면 저 군 통문을 통해야 한다.', '숲은 견습생도 견딜 만하지만, 폐허와 화산지대는 준비가 단단히 되어 있어야 살아 돌아온다.'] },
  // ── 성역 신전 ──
  { id: 'npc-priest', name: '신관 세드릭', role: 'templePriest', icon: '/images/npc/elder.svg', zoneId: 'z-temple', cell: { x: 3, y: 18.7 }, greeting: ['성역에 온 것을 환영하네, 젊은 마법사여.', '이곳은 지친 영혼이 쉬어 가는 곳. 통문 밖에서 쓰러지면 이 신전에서 눈을 뜨게 될 걸세.'] },
  { id: 'npc-saint', name: '성녀 리아나', role: 'saint', icon: '/images/npc/librarian.svg', zoneId: 'z-temple', cell: { x: 5.2, y: 18.9 }, greeting: ['빛이 그대와 함께하기를.', '언젠가 이 손으로 그대에게 축복을 내릴 날이 오겠지요. 지금은 준비 중이랍니다.'] },
  // ── 햇살 농가 ──
  { id: 'npc-farmer', name: '농부 하름', role: 'farmer', icon: '/images/npc/tinker.svg', zoneId: 'z-farm', cell: { x: 11, y: 17.2 }, greeting: ['어이, 견습생! 여기가 햇살 농가일세.', '밭농사에 펫 농장까지 해볼 생각인데, 아직은 삽질만 하고 있다네. 곧 열 테니 기대하게.'] },
]
