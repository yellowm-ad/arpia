      ...
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4">
        <div className="panel-parchment flex flex-col items-center gap-1.5 p-2.5">
          ...
          <div className="w-full space-y-1">
            ...
            <Progress value={(player.mp / player.stats.maxMp) * 100} barClassName="bg-mp" className="h-1.5 w-full" />
          </div>
        </div>
        ...
        <div className="panel-parchment flex flex-col items-center gap-1.5 p-2.5">
          ...
          <div className="w-full space-y-1">
            <Progress value={(pet.hp / Math.max(1, petStats.maxHp)) * 100} barClassName="bg-hp" className="h-1.5 w-full" />
            <Progress value={(pet.mp / Math.max(1, petStats.maxMp)) * 100} barClassName="bg-mp" className="h-1.5 w-full" />
          </div>
        </div>
