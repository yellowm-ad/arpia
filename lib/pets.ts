// ============================================================================
// 계약수(契約獸) 시스템 — 《마법학교 울토르》 기획서 §23~29
// 도감 8종 + 호감도 4구간(낯섦/익숙/친밀/헌신) + 스킬 훈련 + (추후) 진화.
// ============================================================================
...
export const PET_DEFS: PetDef[] = [
  ...
  },
  {
    ...
    rarity: 'rare',
    baseStats: common({ maxHp: 52, atk: 8, def: 4, spd: 9 }),
    growth: { maxHp: 12, maxMp: 4, atk: 1.7, matk: 1.1, def: 1, mdef: 0.8, spd: 1.2, luck: 0.5 },
