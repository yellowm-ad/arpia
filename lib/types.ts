// ============================================================================
// 《마법학교 울토르》 — 도메인 타입 정의
// 세계관 기준: 게임 기획서 초안 「마법학교 울토르」 (오리지널 세계관)
// 모든 화면/컴포넌트는 이 타입을 기준으로 데이터를 주고받는다.
// ============================================================================

/** 삼원(三源) 기본 속성. 상성 순환(밸런스용): 화염 > 빙결 > 대지 > 화염 */
 ...
 * 계통 3단계 각성(불→번개→빛)을 세부 등급으로 나눈 것. 표시 이름은
 * 속성별로 달라진다(constants.ts의 jobTitle()).
 */
...
// ─────────────────────────────────────────────────────────────────────────────
// 상태이상 (9종) — 화상/감전은 화염계, 빙결/침수는 빙결계, 속박/저주는 대지계 계열
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// 계약수 (契約獸) — 기획서 §23~29
// 마력 공명이 가능한 야생 마수와 계약한다. 최대 3마리 보유, 전투 동반 1마리.
// 1차 구현: 활성 슬롯 1마리 + 도감/호감도/훈련 데이터 모델.
// ─────────────────────────────────────────────────────────────────────────────
